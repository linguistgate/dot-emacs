...
#+BEGIN_SRC emacs-lisp
  (use-package org-ref
    :config (setq reftex-default-bibliography '("~/org/resources/bibliograpies/Articles.bib"))

    ;; see org-ref for use of these variables
    (setq org-ref-bibliography-notes ""
          org-ref-default-bibliography '("~/org/resources/bibliographies/Articles.bib")
