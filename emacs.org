...
- [[#configuration][Configuration]]
  ...
  - [[#org-journal-as-task-daybook-org-journal][Org Journal as Task Daybook (=org-journal=)]]
    - [[#comment][COMMENT]]
  - [[#org-with-progrmaming-languages-org-babel][Org With Progrmaming Languages (=org-babel=)]]
...
The directory =~/org/tasks= holds a set of short diary files that together comprise a bullet-journal-esque daybook.
...
The capture block prompts for a task title /and/ a tag; the tag is drawn in tags in the completion file and defaults to what I want, namely, the set of GTD context tags.
...
** Org With Progrmaming Languages (=org-babel=)
