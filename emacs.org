...
#+BEGIN_SRC emacs-lisp
      ...
      :END:" "Template for org-contacts.")
        ...
        (setq org-capture-templates `(("t"                                                                         ; key
                                      ...
                                      ("p" "Protocol" entry (file "~/org/resources/captures/captures.org")
                                       "* %^{Title}\nSource: %u, %c\n #+BEGIN_QUOTE\n%i\n#+END_QUOTE\n\n\n%?")
                                      ("L" "Protocol Link" entry (file "~/org/resources/captures/captures.org")
                                       "* %? [[%:link][%:description]] \nCaptured On: %U")				
                                      )
              )
    )
...
I’m not super sure I’ll want this package around forever. It’s not on MELPA but does a decent job giving me “smart quotes” à la WYSIWG processing, similar to how quotes are entered manually in LaTeX.
...
The other tweak is to register the new way of spelling contractions with =ispell=. This is accomplished in 
