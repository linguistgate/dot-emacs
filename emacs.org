...
The package =pretty-mode= redisplays parts of the Emacs buffer as pretty Unicode symbols. I have it turned on globally at present.
...
#+BEGIN_SRC emacs-lisp
  (use-package org-agenda
    ...
    (org-agenda-files '("~/org/organizer.org"
                        "~/org/areas/teaching/admin-tasks.org")))
