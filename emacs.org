...
- A minimal =org-trello= working setup that allows me keep teaching tasks compartmentalized
...
#+BEGIN_SRC emacs-lisp
  (use-package org-agenda
    ...
    :custom
    (org-agenda-files '("~/org/dashboard.org"
                        "~/org/areas/health.org")))
...
#+BEGIN_SRC emacs-lisp
  (setq org-refile-targets '(("~/org/dashboard.org" :maxlevel . 5)
                             ("~/org/areas/health.org" :maxlevel . 5)
                             ))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package dashboard
    ...
    ;; Set the banner
    (setq dashboard-startup-banner "/home/owl/org/resources/image-collections/classic_rock_albums/test.png")
    ;; Customize widgets
