...
The MELPA package [[https://github.com/abo-abo/org-download][org-download]] is an excellent way to incorporate drag-and-drop abilities into my Org-Mode workflow.
   ...
   2. *Second part of folder name* is
      ...
      - =org-download-heading-lvl= is =n= (name of the current heading with level /n/).
        ...
        - Each file can customize this value:
          #+BEGIN_SRC emacs-lisp :tangle no
            -*- mode: Org; org-download-heaidng-lvl: nil; -*-
          #+END_SRC
...
The crucial issue, and the reason I'm spending some time thinking through this, is that transportability has often become an issue. Every time I start a new setup, the image files don't seem to "come along" and broken links abound. It should be very clear why an image is being downloaded, and there should not be insane proliferation of =/img= directories.
