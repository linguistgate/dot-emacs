...
<<<<<<< HEAD
*************** STARTED Find out if Calibre can be integrated with Org; see devel branch
=======
*************** STARTED Find out if Calibre can be integrated with Org

#+BEGIN_SRC emacs-lisp
  (use-package calibre-mode
    :load-path "user/packages/calibre-mode/")
#+END_SRC
>>>>>>> devel
